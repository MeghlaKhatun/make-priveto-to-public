        ...
        <div className="bg-[#3e0c0c]">
            <div className="navbar py-4 md:py-6 lg:py-12 max-w-7xl mx-auto px-4 md:px-10 lg:px-0">
                <div className="navbar-start">
                    ...
                    <a href="#" className="flex items-end normal-case text-[18px] md:text-xl md:ml-[200px] lg:ml-0 text-2xl text-white lg:text-3xl  italic md:font-bold lg:font-extrabold  "><span className="text-2xl md:text-4xl lg:text-5xl md:font-bold lg:font-extrabold italic ">T</span>echnology & <span className="text-2xl md:text-4xl lg:text-5xl md:font-bold lg:font-extrabold italic ml-3">E</span>lectronics</a>
