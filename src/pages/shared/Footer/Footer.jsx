const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gradient-to-r from-black to-gray-700 text-primary-content">
            <aside>
                <img className="w-[100px]" src="https://i.ibb.co/8g5vK1p/logo-2.png" alt="" />
