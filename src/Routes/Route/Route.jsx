...
const router = createBrowserRouter([
    {
      ...
      children:[
        ...
        },
        {
          ...
          loader:()=>fetch("https://brand-shop-server-side-di7hjzh49-meghlas-projects.vercel.app/products")
        },
        {
          path:"/myCart",
          element:<PrivateRoute><MyCarts></MyCarts></PrivateRoute>,
          loader:()=>fetch("https://brand-shop-server-side-di7hjzh49-meghlas-projects.vercel.app/carts")
        },
        {
          path:"/updateProduct/:id",
          element:<PrivateRoute><UpdateProduct></UpdateProduct></PrivateRoute>,
          loader:({params})=>fetch(`https://brand-shop-server-side-di7hjzh49-meghlas-projects.vercel.app/updateProducts/${params.id}`)
        }
